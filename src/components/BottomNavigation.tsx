...
export function BottomNavigation({ activeTab, onTabChange, mode }: BottomNavigationProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 mx-auto max-w-md border-t border-border bg-background shadow-lg">
